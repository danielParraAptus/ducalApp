...
console.log("cordova-http.js -> cordova es " + typeof cordova);
        if (typeof cordova !== "undefined") {
            console.log("cordova-http.js -> Inicializando objeto http");
            console.log("cordova-http -> window.cordovaHTTP es " + typeof window.cordovaHTTP);
            console.log("cordova-http -> cordova.plugins.cordovaHTTP es " + typeof cordova.plugins.cordovaHTTP);
            http = cordova.plugins.cordovaHTTP || window.cordovaHTTP;
        }
console.log("cordova-http -> Inicializado objeto http");
        ...
        console.log("cordova-http -> Creando variable cordovaHTTP");
        var cordovaHTTP = {
        ...
        console.log("cordova-http -> Devolviendo variable cordovaHTTP");
        return cordovaHTTP;
    });
}
